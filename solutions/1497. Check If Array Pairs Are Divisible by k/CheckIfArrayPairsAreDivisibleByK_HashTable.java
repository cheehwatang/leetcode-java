...
// where 'n' is the length of 'arr', as we traverse 'arr' when recording the frequency in the HashMap,
// and half of 'k' when we check for the pairs summing up to a number divisible by 'k'.
//
// Space Complexity : O(n),
// where 'n' is the length of 'arr', as the worst case is every element in 'arr' results in different remainders with 'k'.

public class CheckIfArrayPairsAreDivisibleByK_HashTable {

    // Approach:
    // Using a HashMap to record the frequency of the integer remainders with 'k'.
