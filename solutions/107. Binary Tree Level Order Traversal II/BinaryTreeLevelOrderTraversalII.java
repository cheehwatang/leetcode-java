...
public class BinaryTreeLevelOrderTraversalII {
    ...
    // Approach:
    // Similar to 102. Binary Tree Level Order Traversal, but add the levels in reverse.
    ...
    public List<List<Integer>> levelOrderBottom(TreeNode root) {
        ...
        // Continue to traverse until the 'queue' is empty.
        while (!queue.isEmpty()) {
            ...
            // Once we finish traversing the level, add the 'level' at the first position of the result.
            integerList.add(0, level);
        }
